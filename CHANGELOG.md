...
### Added
  ...
  - **Process-level machine API**: Added `API.md` as the source of truth for output targets, stdout/stderr rules, schema identities, completion predicates, sweep envelopes, and consumer acceptance.
