...
### Changed
  - **Unified runtime banner**: Centralized the version, copyright, and GPL preamble into one shared banner used before benchmark-specific configuration or status output. Standard and standalone GPU execution now present the same program identity.
