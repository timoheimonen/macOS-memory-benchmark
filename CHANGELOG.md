...
### Changed
  ...
  - **Robust repeated standard summaries**: Multi-loop standard aggregates use median P50 as the headline and report average, P90/P95/P99, sample standard deviation, minimum/maximum, coefficient of variation, and median absolute deviation without filtering outliers.
