...
// -----------------------------------------------------------------------------
// C++ Prototype:
//   extern "C" uint64_t memory_read_strided_loop_asm(const void* src, size_t byteCount, size_t stride);
// Purpose:
...
read_strided_loop:              // Main strided access loop
    // Loop invariants: x2=stride, x1=byteCount, accumulators v0-v1 accumulate XOR.
    ...
    b.lt read_strided_loop  // Loop if more bytes to process
