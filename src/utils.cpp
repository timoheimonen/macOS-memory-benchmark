...
void print_configuration(size_t buffer_size, size_t buffer_size_mb, int iterations, int loop_count, const std::string& cpu_name, int perf_cores, int eff_cores, int num_threads) {
...
void print_statistics(int loop_count,
                      ...
                      const std::vector<double>& all_latency)
{
